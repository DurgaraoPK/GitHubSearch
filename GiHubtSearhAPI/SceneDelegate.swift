...
extension SceneDelegate{
    ...
    func showLoader() {
        ...
        removeLoader()
        loadingView = UIView(frame: self.window!.frame)
        loadingView?.backgroundColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 0.5)
        
        
        loadingIndicator  = UIActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: 70, height: 70))
    ...
    func removeLoader()  {
        ...
        if let loadindicator = loadingIndicator{
